...
public class TLSH_old_v1 {
     ...
     */
    public TLSH_old_v1(final int[][] assignedBitPairsDiffTable) {
    ...
    protected LshBinStruct	lshBin = new LshBinStruct();
    ...
    public boolean compare(TLSH_old_v1 other) {
